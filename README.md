...
<pre>As shown in the above figures, user2 can fully utilize its permissions on the shared directory. user2 is able to:
...
This confirms that user2 has the expected level of access and modification rights on the shared resource</pre>
<br><br>
