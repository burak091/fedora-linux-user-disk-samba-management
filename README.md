...
The command fdisk /dev/nvme0n1 was executed to start the interactive partitioning tool. To create a new partition, the n (new) option was selected. Since the disk did not contain any previous partitions, a primary partition was created by accepting the default partition type.
