...
<pre><code>These permission commands are explained in the Samba installation and file sharing section of the project.The commands were re-executed to configure the permissions and ownership of the files added to the shared directories.</code></pre>
